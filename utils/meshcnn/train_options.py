...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--reg_weight', type=float, default=0, help='l1 regularization weight')
        ...
        self.parser.add_argument('--slide_verts', type=float, default=0.1, help='percent vertices which will be shifted along the mesh surface')
        self.parser.add_argument('--flip_edges', type=float, default=0.1, help='percent of edges to randomly flip')
        ...
        self.parser.add_argument('--optim', type=str, default='Adam', help='plots network weights, etc.')
        self.parser.add_argument('--dropout_p', type=float, default=0, help='dropout layer probability')
        self.is_train = True
